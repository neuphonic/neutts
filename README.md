...
2. **Install `espeak-ng` (required dependency)**
   ...
   > [!CAUTION] `espeak-ng` is an updated version of `espeak`, as of February 2026 on version 1.52.0. Older versions of espeak can exhibit significant phonemisation issues, particularly for non-English languages. Updating your system version of `espeak-ng` to the latest version possible is highly recommended. 
